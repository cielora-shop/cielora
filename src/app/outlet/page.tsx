...
function OutletContent() {
  ...
  const categories = [
    { name: "Outlet Bracelets", count: 0 },
    { name: "Outlet Rings", count: 0 },
    { name: "Outlet Earrings", count: 0 },
    { name: "Outlet Necklaces", count: 0 },
    { name: "Outlet Charms", count: 0 }
  ];
  const prices = [
    { name: "£0 - £20", count: 0 },
    { name: "£20 - £50", count: 0 },
    ...
    <div className="w-full bg-white min-h-screen">
      <div className="px-4 md:px-12 xl:px-24 pt-4 md:pt-8 pb-12">
        ...
        <div className="text-[10px] text-gray-500 mb-[12px]">
          <Link href="/" className="hover:underline">{isEs ? "Inicio" : "Home"}</Link> / <span className="text-black">{isEs ? "Outlet" : "Outlet"}</span>
        </div>

        {/* Title */}
        <h1 className="text-[24px] font-semibold text-black pb-[4px] mb-4">{isEs ? "Outlet" : "Outlet"}</h1>

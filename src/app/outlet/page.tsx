...
function OutletContent() {
  ...
  const dummyProducts = Array.from({ length: 20 }).map((_, i) => {
    ...
    const categoryOptions = ["Outlet Bracelets", "Outlet Rings", "Outlet Earrings", "Outlet Necklaces", "Outlet Charms"];
    ...
    <div className="w-full bg-white min-h-screen">
      <div className="px-4 md:px-12 xl:px-24 pt-4 md:pt-8 pb-12">
        ...
        <div className="text-[10px] text-gray-500 mb-[12px]">
          <Link href="/" className="hover:underline">Home</Link> / <span className="text-black">Outlet</span>
        </div>

...
function RingsContent() {
  ...
  const categories = [
    { name: "Silver Rings", count: 0 },
    { name: "Gold Rings", count: 0 },
    { name: "Crystal Rings", count: 0 },
    { name: "Minimal Rings", count: 0 },
    { name: "Rings for Special Occasions", count: 0 },
    ...
    <div className="w-full bg-white min-h-screen">
      <div className="px-4 md:px-12 xl:px-24 pt-4 md:pt-8 pb-12">
        ...
        <div className="text-[10px] text-gray-500 mb-[12px]">
          <Link href="/" className="hover:underline">{isEs ? "Inicio" : "Home"}</Link> / <span className="text-black">{isEs ? "Anillos" : "Rings"}</span>
        </div>

        {/* Title */}
        <h1 className="text-[24px] font-semibold text-black pb-[4px] mb-4">{isEs ? "Anillos para mujer" : "Rings for women"}</h1>

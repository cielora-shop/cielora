...
function ForHimContent() {
  ...
  const categories = [
    ...
    { name: "Silver bracelets for men", count: 0 },
    { name: "Leather bracelets for men", count: 0 },
    { name: "Chain and Link bracelets", count: 0 },
    { name: "Rings for men", count: 0 },
    { name: "Necklaces for men", count: 0 },
    { name: "Watches", count: 0 },
    { name: "Keychains", count: 0 },
    { name: "Men's Best Sellers", count: 0 }
  ];
  const prices = [
    { name: "£0 - £20", count: 0 },
    { name: "£20 - £50", count: 0 },
  ...
  const dummyProducts = Array.from({ length: 20 }).map((_, i) => {
    ...
    const categoryOptions = ["Bracelets for men", "Silver bracelets for men", "Leather bracelets for men", "Chain and Link bracelets", "Rings for men", "Necklaces for men", "Watches", "Keychains", "Men's Best Sellers"];
    ...
    <div className="w-full bg-white min-h-screen">
      <div className="px-4 md:px-12 xl:px-24 pt-4 md:pt-8 pb-12">
        ...
        <div className="text-[10px] text-gray-500 mb-[12px]">
          <Link href="/" className="hover:underline">Home</Link> / <span className="text-black">For Him</span>
        </div>

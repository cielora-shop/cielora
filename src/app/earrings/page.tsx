...
function EarringsContent() {
  ...
  const categories = [
    { name: "Silver Earrings", count: 0 },
    { name: "Gold Earrings", count: 0 },
    { name: "Pearl Earrings", count: 0 },
    { name: "Hoop Earrings", count: 0 },
    { name: "Drop Earrings", count: 0 },
    { name: "Stud Earrings", count: 0 },
    { name: "Single Earrings", count: 0 },
    { name: "Heart-Shaped Earrings", count: 0 },
    { name: "Best selling earrings", count: 0 },
    { name: "Earrings for Special Occasions", count: 0 }
  ];
  const prices = [
    { name: "£0 - £20", count: 0 },
    { name: "£20 - £50", count: 0 },
  ...
  const topFilters = [
    "Silver Earrings", "Gold Earrings", "Pearl Earrings", "Hoop Earrings", "Drop Earrings", "Stud Earrings", "Single Earrings", "Heart-Shaped Earrings", "Best selling earrings", "Earrings for Special Occasions"
  ];
  ...
  const dummyProducts = Array.from({ length: 20 }).map((_, i) => {
    ...
    const categoryOptions = ["Silver Earrings", "Gold Earrings", "Pearl Earrings", "Hoop Earrings", "Drop Earrings", "Stud Earrings", "Single Earrings", "Heart-Shaped Earrings", "Best selling earrings", "Earrings for Special Occasions"];
    ...
    <div className="w-full bg-white min-h-screen">
      <div className="px-4 md:px-12 xl:px-24 pt-4 md:pt-8 pb-12">
        ...
        <div className="text-[10px] text-gray-500 mb-[12px]">
          <Link href="/" className="hover:underline">Home</Link> / <span className="text-black">Earrings</span>
        </div>

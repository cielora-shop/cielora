...
function BraceletsContent() {
  ...
  const categories = [
    { name: "Silver Bracelets", count: 0 },
    { name: "Gold Bracelets", count: 0 },
    { name: "Leather Bracelets", count: 0 },
    { name: "Pearl Bracelets", count: 0 },
    { name: "Cord Bracelets", count: 0 },
    { name: "Bangle Bracelets", count: 0 },
    { name: "Cuff Bracelets", count: 0 },
    { name: "Link Bracelets", count: 0 },
    { name: "Beaded Bracelets", count: 0 },
    { name: "Bracelets for Men", count: 0 },
    { name: "Birthstone Bracelets", count: 0 },
    { name: "Charm Bracelets", count: 0 },
  ...
  const dummyProducts = Array.from({ length: 20 }).map((_, i) => {
    ...
    const categoryOptions = ["Silver Bracelets", "Gold Bracelets", "Leather Bracelets", "Pearl Bracelets", "Cord Bracelets", "Bangle Bracelets", "Cuff Bracelets", "Link Bracelets", "Beaded Bracelets", "Bracelets for Men", "Birthstone Bracelets", "Charm Bracelets", "Best Selling Bracelets"];

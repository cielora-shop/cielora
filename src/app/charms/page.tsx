...
function CharmsContent() {
  ...
  const categories = [
    { name: "Silver Charms", count: 0 },
    { name: "Gold Charms", count: 0 },
    { name: "Gemstone Charms", count: 0 },
    { name: "Zodiac Charms", count: 0 },
    { name: "Initial Charms", count: 0 },
    { name: "Hoop Charms", count: 0 },
  ...
  const dummyProducts = Array.from({ length: 20 }).map((_, i) => {
    ...
    const categoryOptions = ["Silver Charms", "Gold Charms", "Gemstone Charms", "Zodiac Charms", "Initial Charms", "Hoop Charms", "Heart-shaped charms"];
    ...
    <div className="w-full bg-white min-h-screen">
      <div className="px-4 md:px-12 xl:px-24 pt-4 md:pt-8 pb-12">
        ...
        <div className="text-[10px] text-gray-500 mb-[12px]">
          <Link href="/" className="hover:underline">Home</Link> / <span className="text-black">Charms</span>
        </div>
